            ...
            <div className="container">
                <div className="row" id="pow">
                    <div className="col-12 icons">
                        <svg id="pow_svg" width="368px" height="299px" viewBox="0 0 368 299" fill="none" xmlns="http://www.w3.org/2000/svg">
